...
export default function Chat_(){
    ...
    useEffect(()=>{
        const getConversations = async () => {
            try {
                const res = await axios.get("https://bee-social-app.herokuapp.com/api/conversations/" + user._id);
    ...
    useEffect(()=>{
        const getMessages = async () => {
            try {
                const res = await axios.get("https://bee-social-app.herokuapp.com/api/messages/" + currentChat?._id);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post("https://bee-social-app.herokuapp.com/api/messages", message);
