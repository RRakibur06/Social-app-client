...
export default function Settings() {
    ...
    const submitHandlerProfile = async (e) => {
        ...
        try {
            await axios.put("https://bee-social-app.herokuapp.com/api/users/profilepic/"+user._id, p);
        } catch (error) {
            console.log(error);
        }
    };
    ...
    const submitHandlerCover = async (e) => {
        ...
        console.log(p.picture);
        try {
            await axios.put("https://bee-social-app.herokuapp.com/api/users/coverpic/"+user._id, p);
        } catch (error) {
            console.log(error);
        }
    };
    ...
    const submitHandler = async (e) => {
        ...
        try {
            await axios.put("https://bee-social-app.herokuapp.com/api/users/"+user._id, object);
        } catch (error) {
            console.log(error);
        }
    };
